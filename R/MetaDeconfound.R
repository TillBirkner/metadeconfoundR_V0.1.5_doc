...
#' @param typeCategorical optional character vector of metavariable names to always be treated as categorical
#' @param typeContinuous optional character vector of metavariable names to always be treated as continuous
